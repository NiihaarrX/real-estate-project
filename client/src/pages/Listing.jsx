...
<div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
  ...
  <div className='mt-2'> {/* Added mt-2 for margin-top */}
...
<ul className='text-blue-900 font-semibold text-sm flex flex-wrap items-center gap-4 sm:gap-6 mt-4'> {/* Added mt-4 */}

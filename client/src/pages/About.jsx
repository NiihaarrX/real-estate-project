...
export default function About() {
  return (
    <div className='flex flex-col items-center py-20 px-4 max-w-6xl mx-auto'>
      <h1 className='text-3xl font-bold mb-4 text-slate-800 text-center'>About Sahand Estate</h1>
